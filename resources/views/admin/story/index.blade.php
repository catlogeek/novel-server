        ...
        @foreach ($items as $item)
          <tr>
            ...
            <td>
              ...
              {{-- <a class="btn btn-sm btn-warning" href="{{ route('admin.story.edit', $item) }}">{{ __('messages.headline.edit') }}</a>
              <a class="btn btn-sm btn-danger" href="{{ route('admin.story.destroy', $item) }}">{{ __('messages.headline.destroy') }}</a> --}}
            </td>
          </tr>
        @endforeach
      </tbody>
