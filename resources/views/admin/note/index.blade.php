...
@section('scripts')
  @vite('resources/js/admin.note.index.js')
@endsection
  ...
  <x-admin.card-component bodyClass="p-0 table-responsive" headerClass="bg-secondary">
    ...
    <table class="table table-hover mb-0">
      <thead>
        <tr>
          <th scope="col">ID</th>
          <th class="text-nowrap" scope="col">ユーザ名</th>
        ...
        @foreach ($items as $item)
          <tr>
            ...
            <td class="text-nowrap">
              <a class="btn btn-sm btn-info" href="{{ route('admin.note.show', $item) }}">@lang('messages.headline.show')</a>
            </td>
          </tr>
        @endforeach
      </tbody>
